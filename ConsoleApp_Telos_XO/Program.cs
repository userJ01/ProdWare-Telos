...
namespace ConsoleApp_Telos_XO
{
    class Program
    {
        ...
        private static int CheckWin()
        {
            ...
            if (arr2[1] == arr2[2] && arr2[2] == arr2[3])
            {
                return 1;
            }
            //Winning Condition For Second Row   
            else if (arr2[4] == arr2[5] && arr2[5] == arr2[6])
            {
                return 1;
            }
            ...
            else if (arr2[3] == arr2[6] && arr2[6] == arr2[9])
            {
                return 1;
            }
            #endregion
            ...
            else if (arr2[1] == arr2[5] && arr2[5] == arr2[9])
            {
                return 1;
            }
            else if (arr2[3] == arr2[5] && arr2[5] == arr2[7])
            {
                return 1;
            }
            #endregion
            ...
            else if (arr2[1] != "1" && arr2[2] != "2" && arr2[3] != "3" && arr2[4] != "4" && arr2[5] != "5" && arr2[6] != "6" && arr2[7] != "7" && arr2[8] != "8" && arr2[9] != "9")
            {
                return -1;
            }
            #endregion
